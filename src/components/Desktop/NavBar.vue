<script lang="ts" setup>
    ...
    const { searchQuery, program, currentTime, currentDate, isStartMenuOpen, recentApps } = storeToRefs(store);
    const { toggleMinimized, getCurrentTime, getStartMenuApps, openProgram } = store;
...
<template>
    <div class="navbar">
        ...
        <div class="navbar__search">
            <img class="navbar__search-icon" src="@/assets/images/search-icon.png" alt="Search" />
            <input type="text" class="navbar__search-input" v-model="searchQuery" placeholder="Search..." />
        </div>
        <div
        ...
        >
            <img class="navbar__opened-program-icon" :src="images[program.icon]" alt="Minimized Icon" />
    ...
    <div class="start-menu" v-if="isStartMenuOpen">
        ...
        <div class="start-menu__content">
            ...
            >
                ...
                <span class="start-menu__content-item-name">{{ app.name }}</span>
            </div>
        </div>
